#!/usr/bin/env bash
# ================================================================
# 【非推奨】このスクリプトはプロトタイプです。
# フェーズ1の正式資材は sql/phase1/ および scripts/63_run_expdp.sh を参照。
# 既知の問題: COMPRESSION=ALL は 21c XE では ORA-00439 で失敗。
#             PARALLEL=2 は 21c XE では ORA-39094 で失敗。
# ================================================================
